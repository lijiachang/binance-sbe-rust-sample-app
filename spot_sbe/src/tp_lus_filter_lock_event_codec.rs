...
pub use decoder::TPlusFilterLockEventDecoder;
pub use encoder::TPlusFilterLockEventEncoder;
...
pub const SBE_TEMPLATE_ID: u16 = 608;
...
pub mod encoder {
    ...
    pub struct TPlusFilterLockEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for TPlusFilterLockEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for TPlusFilterLockEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> TPlusFilterLockEventEncoder<'a> {
        ...
        #[inline]
        pub fn unlock_data_encoder(
            self,
            count: u32,
            unlock_data_encoder: UnlockDataEncoder<Self>,
        ) -> UnlockDataEncoder<Self> {
            unlock_data_encoder.wrap(self, count)
        }
    ...
    #[derive(Debug, Default)]
    pub struct UnlockDataEncoder<P> {
        parent: Option<P>,
        count: u32,
        index: usize,
        offset: usize,
    ...
    impl<'a, P> Writer<'a> for UnlockDataEncoder<P>
    where
        P: Writer<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Encoder<'a> for UnlockDataEncoder<P>
    where
        P: Encoder<'a> + Default,
    {
        #[inline]
        ...
        P: Encoder<'a> + Default,
    {
        ...
        /// - version: 0
        #[inline]
        pub fn unlock_time(&mut self, value: i64) {
            let offset = self.offset;
            self.get_buf_mut().put_i64_at(offset, value);
        }
...
pub mod decoder {
    ...
    pub struct TPlusFilterLockEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for TPlusFilterLockEventDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for TPlusFilterLockEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for TPlusFilterLockEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> TPlusFilterLockEventDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn subscription_id(&self) -> Option<u16> {
            ...
            let value = self.get_buf().get_u16_at(self.offset + 9);
            if value == 0xffff_u16 {
                None
            } else {
                Some(value)
        ...
        #[inline]
        pub fn unlock_data_decoder(self) -> UnlockDataDecoder<Self> {
            UnlockDataDecoder::default().wrap(self)
        }
    ...
    #[derive(Debug, Default)]
    pub struct UnlockDataDecoder<P> {
        parent: Option<P>,
        block_length: u16,
        count: u32,
        index: usize,
    ...
    impl<'a, P> ActingVersion for UnlockDataDecoder<P>
    where
    ...
    impl<'a, P> Reader<'a> for UnlockDataDecoder<P>
    where
        P: Reader<'a> + Default,
    {
        #[inline]
    ...
    impl<'a, P> Decoder<'a> for UnlockDataDecoder<P>
    where
        ...
        P: Decoder<'a> + ActingVersion + Default,
    {
        ...
        /// group token - Token{signal=BEGIN_GROUP, name='unlockData', referencedName='null', description='null', packageName='null', id=100, version=0, deprecated=0, encodedLength=16, offset=11, componentTokenCount=12, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        #[inline]
        pub fn parent(&mut self) -> SbeResult<P> {
            self.parent.take().ok_or(SbeErr::ParentNotSet)
        }
